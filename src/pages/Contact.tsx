      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-12 gap-12 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="p-10 rounded-[3rem] bg-[var(--text)] text-[var(--background)] relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--primary)]/20 rounded-bl-full translate-x-8 -translate-y-8" />
            ...
            <div className="p-8 rounded-[2rem] border border-[var(--text)]/10 bg-[var(--primary)]/5">
              <h3 className="font-bold mb-4 flex items-center gap-2 text-[var(--primary)]">
                <Sparkles size={18} />
          ...
          <div className="lg:col-span-7">
            <div className="p-10 md:p-12 rounded-[3rem] border border-[var(--text)]/10 bg-white/50 dark:bg-black/20 backdrop-blur-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-6 py-4 rounded-2xl bg-[var(--text)]/5 border border-transparent focus:border-[var(--primary)]/50 focus:outline-none transition-all"
                      value={formData.name}
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-6 py-4 rounded-2xl bg-[var(--text)]/5 border border-transparent focus:border-[var(--primary)]/50 focus:outline-none transition-all resize-none"
                ...
                <button
                  ...
                  type="submit"
                  className="w-full py-5 rounded-2xl bg-[var(--primary)] text-[var(--background)] font-bold text-lg flex items-center justify-center gap-3 transition-transform hover:scale-[1.02] disabled:opacity-50 disabled:hover:scale-100"
                >
                  {status === 'submitting' ? (
                    'Sending...'
                  ) : status === 'success' ? (
