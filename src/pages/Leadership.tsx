  ...
  const principles = [
    {
      ...
      icon: <Heart className="text-[var(--primary)]" />
    },
    {
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-32">
          {principles.map((p, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-10 rounded-3xl bg-[var(--primary)]/5 border border-[var(--primary)]/10 hover:border-[var(--primary)]/30 transition-all group"
            >
              <div className="w-14 h-14 rounded-2xl bg-[var(--background)] shadow-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                {p.icon}
              </div>
        ...
        <div className="space-y-32 max-w-4xl mx-auto">
          <section className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6 flex items-center gap-3">
                <Lightbulb className="text-[var(--primary)]" /> Technical Strategy
              </h2>
              <p className="text-lg text-[var(--text)]/70 mb-6">
            ...
            <div className="bg-[var(--text)] text-[var(--background)] p-12 rounded-[3rem] rotate-3">
          ...
          <section className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              <div className="p-8 rounded-2xl border border-[var(--text)]/5">
